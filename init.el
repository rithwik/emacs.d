...
;; Identity
;; --------
(setq init-file-user "rithwik"
      user-full-name "Rithwik K"
      user-nick "rithwik"
      user-mail-address "0rithwik@gmail.com")
...
(bind-key [(meta f1)] 'kill-other-buffers)
(bind-key [(meta q)] 'close-and-kill-this-pane)
(define-key emacs-lisp-mode-map (kbd "C-c .") 'find-function-at-point)
(global-set-key [f9] 'deft)
;; pipe operator in R
(global-set-key (kbd "C-c m") " %>%")
;; for my keyboard which won't type j or J
(global-set-key (kbd "C-c k") "j")
(global-set-key (kbd "C-c M-k") "J")
